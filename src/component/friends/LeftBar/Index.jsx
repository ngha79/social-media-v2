...
const LeftBar = () => {
  ...
  return (
    <div className="md:w-[360px] w-full h-max">
      <div className="md:fixed w-full h-max top-[57px] left-0 md:w-[360px] md:h-full border-r border-gray-200 dark:border-dark-icon-hover bg-white dark:bg-dark-nav">
        <div className="px-2">
