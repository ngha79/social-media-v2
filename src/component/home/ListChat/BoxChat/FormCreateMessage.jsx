...
import { createNewMessage } from '../../../../store/conversation/conversationSlice'

const FormCreateMessage = ({ conversation }) => {
  ...
  return (
    <div className="p-3 h-max sticky bottom-0 left-0 flex items-center justify-between gap-4">
      <button
